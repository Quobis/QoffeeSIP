...
(function() {
  ...
  UI = (function(_super) {
    ...
    UI.prototype.registerSubmit = function(e) {
      ...
      this.api.on("localstream", function() {
        return _this.$mediaLocal.removeClass("hidden");
      });
      return this.api.on("remotestream", function() {
        if (_this.api.mediaConstraints.video) {
          return _this.$mediaRemote.removeClass("hidden");
        }
      });
    };
    ...
    UI.prototype.newState = function(state, data) {
      ...
      switch (this.state) {
        case 3:
          ...
          this.stopTimer();
          this.$videos.removeClass("active");
          this.$mediaLocal.css({
            marginTop: "0px"
          });
        ...
        case 5:
          ...
          return document.getElementById("sound-calling").play();
        case 6:
          this.ext2 = data.ext;
        ...
        case 8:
          ...
          this.$videos.addClass("active");
          h = this.$mediaLocal.height();
          this.$mediaLocal.css({
            marginTop: "-" + h + "px"
          });
          this.$mediaLocal.removeClass("hidden");
