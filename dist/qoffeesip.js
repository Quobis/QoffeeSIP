...
(function() {
  var Parser, QS, RTC, RTCIceCandidate, RTCPeerConnection, RTCSessionDescription, SipStack, SipTransaction, attachMediaStream, createIceServer, getUserMedia, reattachMediaStream, webrtcDetectedBrowser, webrtcDetectedVersion,
...
=======
  ...
  SipStack = (function(_super) {
    ...
    SipStack.prototype.configure = function(options) {
      var _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
        _this = this;
      this.server = options.server;
      this.iceServer = options.iceServer;
      this.hackViaTCP = options.hackViaTCP;
      this.hackIpContact = options.hackIpContact;
      this.hackno_Route_ACK_BYE = options.hackno_Route_ACK_BYE;
      this.hackContact_ACK_MESSAGES = options.hackContact_ACK_MESSAGES;
      this.hackUserPhone = options.hackUserPhone;
      ...
      return console.log("Creating QS with @hackViaTCP= " + this.hackViaTCP + " @hackIpContact=" + this.hackIpContact + " @hackno_Route_ACK_BYE=" + this.hackno_Route_ACK_BYE + " @hackContact_ACK_MESSAGES=" + this.hackContact_ACK_MESSAGES + " @hackUserPhone=" + this.hackUserPhone);
    };
  ...
  QS = (function(_super) {
    ...
    QS.prototype.register = function(options, uri, pass, userAuthName) {
      var _this = this;
      if (pass == null) {
        pass = "";
      }
      this.sipStack.configure({
        ...
        onopen: function() {
          return _this.sipStack.register(uri, pass, userAuthName);
        }
      });
