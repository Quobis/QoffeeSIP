...
(function() {
  ...
  Parser = (function() {
    ...
    Parser.parse = function(pkt) {
      ...
      _.extend(message, this.parseServiceRoute(pkt));
    ...
    Parser.parseServiceRoute = function(pkt) {
      var line, lineRe, serviceRoutes;
      ...
      line = lineRe.exec(pkt);
      serviceRoutes = [];
      if ((line != null ? line.length : void 0) > 1) {
        serviceRoutes = line[1].split(",");
      }
      return {
  ...
  SipStack = (function(_super) {
            ...
            switch (message.responseCode) {
              case 200:
                ...
                if (message.serviceRoutes.length) {
                  return _this.serviceRoutes = message.serviceRoutes;
                }
                break;
              case 401:
    ...
    SipStack.prototype.createMessage = function(transaction) {
      var address, authExt, authUri, data, opaque, qop, rr, serviceRoute, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ...
      switch (transaction.meth) {
        case "REGISTER":
          transaction.requestUri = "sip:" + (this.domain || this.sipServer);
      ...
      if ((transaction.cseq.meth === "INVITE" && transaction.meth !== "ACK") && (_.isArray(transaction.recordRoutes))) {
        ...
        switch (transaction.meth) {
          ...
          case "CANCEL":
            ...
            break;
          case "INVITE":
            if ((_ref1 = transaction.recordRoutes) != null ? _ref1.length : void 0) {
              _ref2 = this.serviceRoutes;
              for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
                serviceRoute = _ref2[_j];
      ...
      if (transaction.nonce != null) {
        ...
        if (transaction.userAuthName) {
          authExt = transaction.userAuthName;
        }
  ...
  QS = (function(_super) {
    ...
    QS.prototype.updateMediaState = function(to) {
      var content;
      content = JSON.stringify({
    ...
    QS.prototype.chat = function(ext, text) {
      var content;
      content = JSON.stringify({
